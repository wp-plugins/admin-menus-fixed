...
Ozh' Admin Drop Down Menu + WordPress 3.5-3.7 Toolbar & Standard Admin Menu Fixed to the Top and Side of the Admin Screens. Less Scrolling!
...
* [Bengal and Maine Coon Rescue](http://bengalmania.org/)
...
If you'd like to help a real starving artist, please [help us buy food and medical care for our Bengal and Maine Coon rescues.](http://bengalmania.org/)

== Screenshots ==

1. **WordPress Toolbar + Ozh' Admin Drop Down Menu - Both Fixed**
2. **Ozh' Admin Drop Down Menu in MiniMode - WordPress Toolbar Disabled**
3. **WordPress Toolbar + Standard Menu Expanded - Both Fixed** (WordPress 3.5-3.7)
4. **WordPress Toolbar + Standard Menu Expanded | Page Scrolled** (WordPress 3.5-3.7)
5. **WordPress Toolbar + Standard Menu Collapsed - Both Fixed** (WordPress 3.5-3.7)
6. **WordPress Toolbar + Standard Menu Collapsed | Page Scrolled** (WordPress 3.5-3.7)
